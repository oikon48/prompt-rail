...
The viewport bar's shade is a fixed gray rather than a theme color — a Raster cell takes an RGB value or the terminal default, not a theme name. It lights in whole prompts, not in fractions of one: a prompt half off the screen counts as on it.
